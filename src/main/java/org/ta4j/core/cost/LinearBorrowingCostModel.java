...
public class LinearBorrowingCostModel implements CostModel {
    ...
    /**
     * Slope of the linear model - fee per timeFrame
     */
     ...
     * @param feePerPeriod the coefficient (e.g. 0.0001 for 1bp per timeFrame)
     */
    ...
    public Num calculate(Num price, Num amount) {
        // borrowing costs depend on borrowed timeFrame
