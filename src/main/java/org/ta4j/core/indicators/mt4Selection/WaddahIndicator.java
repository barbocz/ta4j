...
public class WaddahIndicator extends CachedIndicator<Num> {
    ...
    public WaddahIndicator(TimeSeries series,Type type) {
        super(series);
        this.type=type;
    ...
    protected Num calculate(int index) {
        ...
        if (type==Type.EXPLOSION) {
            return bollingerBandsUpperIndicator.getValue(index).minus(bollingerBandsLowerIndicator.getValue(index));
        } else {
