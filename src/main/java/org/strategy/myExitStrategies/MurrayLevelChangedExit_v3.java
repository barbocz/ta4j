...
public class MurrayLevelChangedExit_v3 extends Strategy {
...
//        double entryLevel = tradeEngine.series.numOf(order.parameters.get("entry")).doubleValue();
        ...
        if (order.phase == 0) {
            ...
            if (order.type == Order.Type.BUY) {
                takeProfit = order.openPrice + 0.00040;
...
//                    }
                ...
                if (order.phase==0 && tradeEngine.series.getCurrentIndex() - openIndex > 6)
