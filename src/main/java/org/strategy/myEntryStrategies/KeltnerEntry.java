...
import org.ta4j.core.indicators.helpers.TradeCounterIndicator;
...
//        SMAIndicator longSma = new SMAIndicator(closePrice, 8);
        ...
        CCIIndicator longCci = new CCIIndicator(tradeEngine.series, 30);
        Num cciUpperLimit = tradeEngine.series.numOf(150);
        Num cciLowerLimit = tradeEngine.series.numOf(-150);
